...
<body>
    ...
    <img src="images/solr.png" width="200px" style="margin-left:50px;"/>
            ...
            <div class="search-block">
                <form class="form-inline search-form"  action="WeiboQuery" method="post" novalidate="novalidate">
                    <input type="text" class="search-input" maxlength="128" id="mrs_qstring" name="query">
                    <input type="submit" value="搜索" class="btn btn-primary btn-large" id="mrs_qbutton">
                </form>
        	</div>
